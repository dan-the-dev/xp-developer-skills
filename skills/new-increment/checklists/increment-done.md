...
- [ ] Working on **feature branch** `feat/<feature-stem>` (not a per-increment branch); no merge to main this invocation unless user asked ([`delivery-process.md`](../../../docs/delivery-process.md) §1a)
...
- [ ] During RGR: **scoped** tests only (touched test/file/package) — not full suite every step
