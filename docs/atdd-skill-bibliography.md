...
- **Fowler, Martin.** [Specification By Example](https://martinfowler.com/bliki/SpecificationByExample.html) (bliki); [Testing Guide](https://martinfowler.com/testing/).  
  Examples over abstract specs; testing roles in agile delivery.
...
| Flake control and trust | Farley on effective acceptance testing; CD pipeline discipline |
