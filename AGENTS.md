...
- [`docs/project-verification.md`](docs/project-verification.md) — tests, lint, format, SonarQube, and all project gates after every code change
- [`docs/test-strategy-selection.md`](docs/test-strategy-selection.md) — which test layers and techniques to adopt per slice (mutation, contract, property-based, etc.)
